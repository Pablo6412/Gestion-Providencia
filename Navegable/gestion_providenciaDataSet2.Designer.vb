...
Namespace Gestion
    ...
    Partial Public Class gestion_providenciaDataSet
        ...
        Private Sub InitClass()
            ...
            Me.Prefix = ""
            Me.Namespace = "http://tempuri.org/gestion_providenciaDataSet2.xsd"
...
Namespace Gestion.gestion_providenciaDataSetTableAdapters
    ...
    Partial Public Class alumnosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[alumnos] WHERE (([codigo_alumno] = @Original_codigo_alumno) AN"& _ 
                "D ([codigo_familia] = @Original_codigo_familia) AND ([codigo_arancel] = @Origina"& _ 
                "l_codigo_arancel) AND ([codigo_curso] = @Original_codigo_curso) AND ((@IsNull_co"& _ 
                "digo_año = 1 AND [codigo_año] IS NULL) OR ([codigo_año] = @Original_codigo_año))"& _ 
                " AND ([codigo_beca] = @Original_codigo_beca) AND ([codigo_descuento] = @Original"& _ 
                "_codigo_descuento) AND ([codigo_taller1] = @Original_codigo_taller1) AND ([codig"& _ 
                "o_taller2] = @Original_codigo_taller2) AND ([codigo_taller3] = @Original_codigo_"& _ 
                "taller3) AND ([nombre_apellido_alumno] = @Original_nombre_apellido_alumno) AND ("& _ 
                "[edad] = @Original_edad) AND ([fecha_nacimiento] = @Original_fecha_nacimiento) A"& _ 
                "ND ([dni] = @Original_dni) AND ([fecha_ingreso] = @Original_fecha_ingreso) AND ("& _ 
                "[hermano_numero] = @Original_hermano_numero) AND ([alumno_especial] = @Original_"& _ 
                "alumno_especial) AND ((@IsNull_fecha_baja = 1 AND [fecha_baja] IS NULL) OR ([fec"& _ 
                "ha_baja] = @Original_fecha_baja)) AND ((@IsNull_estado = 1 AND [estado] IS NULL)"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[alumnos] ([codigo_familia], [codigo_arancel], [codigo_curso], "& _ 
                "[codigo_año], [codigo_beca], [codigo_descuento], [codigo_taller1], [codigo_talle"& _ 
                "r2], [codigo_taller3], [nombre_apellido_alumno], [edad], [fecha_nacimiento], [dn"& _ 
                "i], [fecha_ingreso], [hermano_numero], [alumno_especial], [Observaciones], [fech"& _ 
                "a_baja], [estado]) VALUES (@codigo_familia, @codigo_arancel, @codigo_curso, @cod"& _ 
                "igo_año, @codigo_beca, @codigo_descuento, @codigo_taller1, @codigo_taller2, @cod"& _ 
                "igo_taller3, @nombre_apellido_alumno, @edad, @fecha_nacimiento, @dni, @fecha_ing"& _ 
                "reso, @hermano_numero, @alumno_especial, @Observaciones, @fecha_baja, @estado);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT codigo_alumno, codigo_familia, codigo_arancel, codigo_curso, codigo_año,"& _ 
                " codigo_beca, codigo_descuento, codigo_taller1, codigo_taller2, codigo_taller3, "& _ 
                "nombre_apellido_alumno, edad, fecha_nacimiento, dni, fecha_ingreso, hermano_nume"& _ 
                "ro, alumno_especial, Observaciones, fecha_baja, estado FROM alumnos WHERE (codig"& _ 
                "o_alumno = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[alumnos] SET [codigo_familia] = @codigo_familia, [codigo_arancel] ="& _ 
                " @codigo_arancel, [codigo_curso] = @codigo_curso, [codigo_año] = @codigo_año, [c"& _ 
                "odigo_beca] = @codigo_beca, [codigo_descuento] = @codigo_descuento, [codigo_tall"& _ 
                "er1] = @codigo_taller1, [codigo_taller2] = @codigo_taller2, [codigo_taller3] = @"& _ 
                "codigo_taller3, [nombre_apellido_alumno] = @nombre_apellido_alumno, [edad] = @ed"& _ 
                "ad, [fecha_nacimiento] = @fecha_nacimiento, [dni] = @dni, [fecha_ingreso] = @fec"& _ 
                "ha_ingreso, [hermano_numero] = @hermano_numero, [alumno_especial] = @alumno_espe"& _ 
                "cial, [Observaciones] = @Observaciones, [fecha_baja] = @fecha_baja, [estado] = @"& _ 
                "estado WHERE (([codigo_alumno] = @Original_codigo_alumno) AND ([codigo_familia] "& _ 
                "= @Original_codigo_familia) AND ([codigo_arancel] = @Original_codigo_arancel) AN"& _ 
                "D ([codigo_curso] = @Original_codigo_curso) AND ((@IsNull_codigo_año = 1 AND [co"& _ 
                "digo_año] IS NULL) OR ([codigo_año] = @Original_codigo_año)) AND ([codigo_beca] "& _ 
                "= @Original_codigo_beca) AND ([codigo_descuento] = @Original_codigo_descuento) A"& _ 
                "ND ([codigo_taller1] = @Original_codigo_taller1) AND ([codigo_taller2] = @Origin"& _ 
                "al_codigo_taller2) AND ([codigo_taller3] = @Original_codigo_taller3) AND ([nombr"& _ 
                "e_apellido_alumno] = @Original_nombre_apellido_alumno) AND ([edad] = @Original_e"& _ 
                "dad) AND ([fecha_nacimiento] = @Original_fecha_nacimiento) AND ([dni] = @Origina"& _ 
                "l_dni) AND ([fecha_ingreso] = @Original_fecha_ingreso) AND ([hermano_numero] = @"& _ 
                "Original_hermano_numero) AND ([alumno_especial] = @Original_alumno_especial) AND"& _ 
                " ((@IsNull_fecha_baja = 1 AND [fecha_baja] IS NULL) OR ([fecha_baja] = @Original"& _ 
                "_fecha_baja)) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Ori"& _ 
                "ginal_estado)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT codigo_alumno, codigo_familia, codigo_arancel, codigo_c"& _ 
                "urso, codigo_año, codigo_beca, codigo_descuento, codigo_taller1, codigo_taller2,"& _ 
                " codigo_taller3, nombre_apellido_alumno, edad, fecha_nacimiento, dni, fecha_ingr"& _ 
                "eso, hermano_numero, alumno_especial, Observaciones, fecha_baja, estado FROM alu"& _ 
                "mnos WHERE (codigo_alumno = @codigo_alumno)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT codigo_alumno, codigo_familia, codigo_arancel, codigo_curso, codigo_año, c"& _ 
                "odigo_beca, codigo_descuento, codigo_taller1, codigo_taller2, codigo_taller3, no"& _ 
                "mbre_apellido_alumno, edad, fecha_nacimiento, dni, fecha_ingreso, hermano_numero"& _ 
                ", alumno_especial, Observaciones, fecha_baja, estado FROM dbo.alumnos"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As gestion_providenciaDataSet.alumnosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As gestion_providenciaDataSet.alumnosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As gestion_providenciaDataSet.alumnosDataTable = New gestion_providenciaDataSet.alumnosDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As gestion_providenciaDataSet.alumnosDataTable) As Integer
