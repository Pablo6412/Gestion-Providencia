...
Public Class FrmPagosDelMes
    ...
    Private Sub UltimoPago()
        ...
        LblFechaDeUltimoPago.Text = comandoUltimo.ExecuteScalar
    End Sub
    ...
    Private Sub UltimoVencimiento()
        ...
        If comandoUltimoVencimiento.ExecuteNonQuery <> 0 Then
            LblPeriodoDePago.Text = comandoUltimoVencimiento.ExecuteScalar
        End If
    End Sub
    ...
    Private Sub BtnGuardar2_Click(sender As Object, e As EventArgs) Handles BtnGuardar2.Click
        ...
        If TxtMatricula.Text <> "" Or TxtArancel.Text <> "" Or TxtComedor.Text <> "" Or TxtMateriales.Text <> "" Or TxtTalleres.Text <> "" Or TxtCampamento.Text <> "" Or TxtAdicional.Text <> "" Or TxtSinAsignar1.Text <> "" Or TxtSinasignar2.Text <> "" Or TxtSinAsignar3.Text <> "" Then
            ...
            Dim cadena As String = "UPDATE detalle_pago_escolar 
                                    ...
                                    WHERE codigo_familia = " & Val(CbxCodigo.Text) & " AND periodo_de_pago = '" & LblPeriodoDePago.Text & "' "
    ...
    Private Sub FormaPago(efectivoDef)
        ...
        comando.Parameters.AddWithValue("@periodo_de_pago", LblPeriodoDePago.Text)
        comando.Parameters.AddWithValue("@fecha_pago", DtpFechaDePago.Value)
    ...
    Sub DataGrid1()
        ...
        Try
            ...
            '        '        total += Convert.ToDouble(fila.Cells("REQ").Value)
            '        '    End If
            '        'Next
    ...
    'Private Sub dgvhijos_CurrentCellDirtyStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles DgvHijos1.CurrentCellDirtyStateChanged
    '    Try
    ...
    End Sub
    Private Sub DgvHijos1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvHijos1.CellContentClick
        'DataGrid1()

        RecorreDgvHijos1()
    End Sub

    'Private Sub dgvhijos1_CellValueChanged(ByVal sender As Object, ByVal e As DataGridViewCellEventArgs) Handles DgvHijos1.CellValueChanged
    'Try
    '    If DgvHijos1.Columns(e.ColumnIndex).Name = "Check" Then
    'Dim checkCell As DataGridViewCheckBoxCell
    '        'CType(DgvHijos1.Rows(e.RowIndex).Cells("Check"),
    '        'DataGridViewCheckBoxCell)
    '        'If CType(checkCell.Value, [Boolean]) = True Then
    '        '    'Me.txtOf.Text = Valnum(grd.CurrentRow.Cells("nof").Value)
    '        '    'Me.txtOperacion.Text = Valnum(grd.CurrentRow.Cells("noperacion").Value)
    '        '    'limpiar
    '        'Else
    '        'Me.txtOf.Text = ""
    ...
    'abrir()
    'CalculoTotal()
    'MsgBox("Estado: " & Me.DgvHijos1.Rows(e.RowIndex).Cells("Check").Value)


    'End Sub

    'Private Sub DgvHijos1_SelectionChanged(sender As Object, e As EventArgs) Handles DgvHijos1.SelectionChanged
    '    DataGrid1()
    '    'PagoTotal()
    'End Sub

    'Private Sub dataGridView_Alineaciones_CurrentCellDirtyStateChanged(sender As Object, e As EventArgs)

    'DataGrid1()
    'PagoTotal()
    'End Sub

    'Private Sub Dgvhijos1_CurrentCellDirtyStateChanged(ByVal sender As Object, ByVal e As EventArgs) Handles DgvHijos1.CurrentCellDirtyStateChanged

    '    DataGrid1()

    '    'Detectamos el checkbox marcado 
    '    'If DgvHijos1.CurrentCell.ColumnIndex = 1 Then
    '    '    If DgvHijos1.IsCurrentCellDirty Then

    '    '        DgvHijos1.CommitEdit(DataGridViewDataErrorContexts.Commit)
    '    '        For Each fila As DataGridViewRow In DgvHijos1.Rows

    '    '            If Not fila Is DgvHijos1.Rows(DgvHijos1.CurrentCell.RowIndex) Then
    '    '                fila.Cells(1).ReadOnly = False
    '    '                fila.Cells(1).Value = False
    '    '            End If
    '    '        Next

    '    '        CeldaActual = DataGridView1.CurrentCell.RowIndex.ToString
    '    '        LLamadasExplicacionFormulas()

    '    '        ''    Dim dgvCell As DataGridViewCell = DataGridView1.CurrentCell
    '    '        ''    dgvCell.Value = False
